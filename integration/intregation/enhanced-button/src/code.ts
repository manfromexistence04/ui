...
const tailwindCode = `const config = {
    extend: {
        keyframes: {
          "shine": {
...
const exampleButtonGooeyLeft = `import { Button } from "./ui/button";

<Button variant="gooeyLeft">
Gooey left
</Button>`

const exampleButtonGooeyRight = `import { Button } from "./ui/button";

<Button variant="gooeyRight">
Gooey right
</Button>`

const exampleButtonShine = `import { Button } from "./ui/button";

<Button variant="shine">
Shine
</Button>`

const exampleButtonRingHover = `import { Button } from "./ui/button";

<Button variant="ringHover">
Ring hover
</Button>`

const exampleButtonLinkHover1 = `import { Button } from "./ui/button";

<Button variant="linkHover1">
Link hover 1
</Button>`

const exampleButtonLinkHover2 = `import { Button } from "./ui/button";
