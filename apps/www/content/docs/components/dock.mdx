...
```bash
npx shadcn@latest add "https://manfromexistence-ui.vercel.app/r/dock-rainbow" "https://manfromexistence-ui.vercel.app/r/dock"
```
...
<ComponentPreview
  name="dock"
  className="[&_.preview>[data-orientation=vertical]]:sm:max-w-[70%]"
  description="A dock with custom zoom in it."
/> */}